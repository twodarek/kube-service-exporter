...
#              ]
# )
#docker_build('kube-service-exporter', './')
custom_build(
  'kube-service-exporter',
  'docker build -t $EXPECTED_REF ./',
  ['./pkg', './main.go', './Dockerfile'],
)

k8s_yaml([
  'config/kubernetes/dev/kse.yaml',
  'config/kubernetes/dev/consul.yaml',
  'config/kubernetes/dev/fake-statsd.yaml',
  'config/kubernetes/dev/httpbin.yaml'
])
...
#
# k8s_yaml([
#     'config/kubernetes/dev/namespaces/kube-network-mesh-check-dev.yaml',
#     'config/kubernetes/dev/roles/kube-network-mesh-check.yaml',
#     'config/kubernetes/dev/rolebindings/kube-network-mesh-check.yaml',
#     'config/kubernetes/dev/daemonsets/kube-network-mesh-check.yaml',
#     'config/kubernetes/dev/services/kube-network-mesh-check.yaml'
# ])
